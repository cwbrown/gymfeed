  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved workout as @workout" do
        ...
        post :create, {:workout => { "name" => "invalid value" }}, valid_session
        assigns(:workout).should be_a_new(Workout)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested workout" do
        ...
        Workout.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => workout.to_param, :workout => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the workout as @workout" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Workout.any_instance.stub(:save).and_return(false)
        put :update, {:id => workout.to_param, :workout => { "name" => "invalid value" }}, valid_session
        assigns(:workout).should eq(workout)
      end
